class VideoPlayer {
     ...
     */
    setupVideos() {
        const videoElements = document.querySelectorAll(".movie-thumbnail");
     ...
     */
    setupVideoHandlers(video, videoId) {
     ...
     */
    handleVideoError(video, videoId, event) {
        const error = {
